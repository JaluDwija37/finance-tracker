...
- R-03 PASS: browser diuji pada 360, 390, dan 1365 piksel; tidak ada overflow horizontal.
...
- R-23 PASS: wordmark hanya berupa nama produk sebagai teks; navigasi mengarah ke tiga halaman yang sudah berfungsi.
- R-24 PASS: Beranda, Transaksi, dan Akun masing-masing membuka halaman nyata.
- R-25 PASS: kontras teks sekunder 5.99:1 hingga 8.45:1; tombol 15.95:1; batas field 3.90:1.
- R-26 PASS: login, logout, tambah akun, tambah transaksi, tautan navigasi, CTA keadaan kosong, dan tombol coba lagi diuji di browser.
...
- R-35 PASS: build dan Docker sehat; klik login, logout, semua nav, CTA kosong, formulir, validasi transfer, serta tombol pemulihan telah dicatat lewat uji browser.
...
- R-04 PASS: tidak ada ikon dekoratif.
...
- Focal point PASS: judul login dan nilai aset adalah fokus masing-masing layar.
...
- C-4 PASS: keadaan kosong, loading, error, layar ponsel, desktop, dan keyboard diuji.
